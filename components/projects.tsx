...
const ProjectDossier = ({
  ...
  return (
    ...
    >
      <div className="grid min-h-64 gap-6 p-5 md:grid-cols-12 md:p-7 lg:min-h-72 lg:p-8">
        <div className="md:col-span-7">
          ...
          {technologies.length > 0 && (
            <ul
              ...
              className="mt-5 flex max-w-2xl flex-wrap gap-1.5"
            >
              {technologies.slice(0, 5).map((technology) => (
                <li
                  key={technology}
                  className="rounded-xs bg-muted px-2.5 py-1 font-pp-neue-montreal text-xs text-muted-foreground"
                >
                  {technology}
                </li>
              ))}
          ...
          <p className="mt-5 max-w-xl font-pp-neue-montreal text-base leading-5 text-foreground/85 sm:text-lg">
        ...
        <div className="md:col-span-5 md:flex md:justify-end">
          <Link
            href={href}
            className="inline-flex min-h-10 items-center gap-1.5 self-start rounded-xs bg-foreground px-4 text-xs font-medium text-background outline-none transition-transform duration-150 ease-out active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-4 focus-visible:ring-offset-background motion-reduce:transition-none motion-reduce:active:transform-none"
          >
            <CornerDownRight
              aria-hidden="true"
              className="size-3.5"
      ...
      {marqueeImages.length > 0 && (
        <Link
          ...
          className="project-marquee block overflow-hidden px-2 outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring"
        >
          <div
                  ...
                  >
                    <Image
                      ...
                      alt={
                        duplicate
                          ? ""
                          : `${project.title} interface view ${imageIndex + 1}`
                      }
                      fill
    ...
    <section id="projects" className="w-full py-32 md:py-48">
      <div className="container mx-auto px-4 lg:px-6">
        ...
        >
          ...
          >
            Full-stack products built for real operations, from veterinary care
