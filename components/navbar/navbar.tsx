  ...
  return (
    <>
      ...
      <div className="fixed top-6 left-0 right-0 z-50 px-4">
        <nav className="backdrop-blur-xl border border-dark/10 container mx-auto rounded-md px-6 md:px-4 transition-all duration-300 dark:border-white/10 dark:bg-background/80">
